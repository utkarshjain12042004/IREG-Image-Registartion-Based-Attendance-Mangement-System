...
class IREG(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        for F in (IREG_Main_Menu_Page, Start_Attendance_Page, Automated_Attendance_Method_Page, View_Attendance_Page, Student_Account_Management_1_Page, Student_Account_Management_Page, Add_New_Student_Page, Settings_Page):
...
class IREG_Main_Menu_Page(tk.Frame):
    def __init__(self, parent, controller):
        ...
        account_Management_Button = ttk.Button(self, text="Account Management", command=lambda: controller.show_frame(Student_Account_Management_1_Page), style="big.TButton")
...
# ========================================================================================================================================== #
# ========================================================================================================================================== #
class Student_Account_Management_1_Page(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)

        # Adding the Student Account Management Menu Label
        Student_Account_Management_Menu_Lbl = tk.Label(self, text="Account Management", font=FONT1)
        ...
        # Adding the Account Management Button
        teacher_account_management_Button = ttk.Button(self, text="Teacher Account Management", style="big.TButton")
...
class Student_Account_Management_Page(tk.Frame):
    ...
    # Adding in the student related text boxes and labels
        ...
        self.var_student_ID = str(len(student_IDs) + 1)
        conn.close()

        # Adding a student id label and textbox
        studentID_lbl = Label(self, text = "Student ID: ", font=FONT3)
        studentID_lbl.grid(row=0, column=0, padx=5, pady=(100,15), sticky=E)
        studentID_lbl.config(bg="Black", fg="White")

        new_studentID_lbl = Label(self, text = self.var_student_ID, font=FONT3)
        new_studentID_lbl.grid(row=0, column=1, padx=5, pady=(100,15), sticky=W)
        new_studentID_lbl.config(bg="Black", fg="White")

        # Adding a Student Email label and textbox
        student_email_lbl = Label(self, text = "Student Email: ", font=FONT3)
        student_email_lbl.grid(row=0, column=2, padx=5, pady=(100,15), sticky=E)
        ...
        student_email_textbox.grid(row=0, column=3, padx=5, pady=(100,15), sticky=W)

        # Adding a first name label and textbox
        first_name_lbl = Label(self, text = "First Name: ", font=FONT3)
        first_name_lbl.grid(row=2, column=0, padx=5, pady=15, sticky=E)
        ...
        first_name_textbox.grid(row=2, column=1, padx=5, pady=15, sticky=W)

        # Adding a last label and textbox
        last_name_lbl = Label(self, text = "Last Name: ", font=FONT3)
        last_name_lbl.grid(row=2, column=2, padx=5, pady=15, sticky=E)
        ...
        last_name_textbox.grid(row=2, column=3, padx=5, pady=15, sticky=W)

        # Adding a Student Date Of Admission label and textbox
        date_of_admission_lbl = Label(self, text = "Date Of Admission: ", font=FONT3)
        date_of_admission_lbl.grid(row=3, column=0, padx=5, pady=15, sticky=E)
        ...
        date_of_admission_textbox.grid(row=3, column=1, padx=5, pady=15, sticky=W)

        # Adding a date of birth label and textbox
        date_of_birth_lbl = Label(self, text = "Date of Birth: ", font=FONT3)
        date_of_birth_lbl.grid(row=3, column=2, padx=5, pady=15, sticky=E)
        ...
        date_of_birth_textbox.grid(row=3, column=3, padx=5, pady=15, sticky=W)

        # Father's Information
        # Adding a father first name label and textbox
        father_name_lbl = Label(self, text = "Father's Name: ", font=FONT3)
        father_name_lbl.grid(row=4, column=0, padx=4, pady=15, sticky=E)
        ...
        father_name_textbox.grid(row=4, column=1, padx=5, pady=15, sticky=W)

        # Adding father's email label and text box
        father_email_lbl = Label(self, text = "Father's Email: ", font=FONT3)
        father_email_lbl.grid(row=4, column=2, padx=4, pady=15, sticky=E)
        ...
        father_email_textbox.grid(row=4, column=3, padx=5, pady=15, sticky=W)

        # Mother's Information
        # Adding a father first name label and textbox
        mother_name_lbl = Label(self, text = "Mother's Name: ", font=FONT3)
        mother_name_lbl.grid(row=5, column=0, padx=4, pady=15, sticky=E)
        ...
        mother_name_textbox.grid(row=5, column=1, padx=5, pady=15, sticky=W)

        # Adding father's email label and text box
        mother_email_lbl = Label(self, text = "Mother's Email: ", font=FONT3)
        mother_email_lbl.grid(row=5, column=2, padx=4, pady=15, sticky=E)
        ...
        mother_email_textbox.grid(row=5, column=3, padx=5, pady=15, sticky=W)
        ...
        search_lbl.grid(row=6, column=0, padx=15, pady=5, sticky=W)
        search_lbl.config(bg="Black", fg="White")

        # Adding a Search by combo box
        search_combobox=ttk.Combobox(self, textvariable=self.var_search_by_combobox, font=FONT3, width=17, state="readonly")
        search_combobox["values"] = ("Select", "Student_ID", "First_Name", "Last_Name","Date_of_Birth", "Date_Of_Admission")
        search_combobox.current(0)
        search_combobox.grid(row=6, column=0, columnspan=2, padx=(110,0), pady=5, sticky=W)

        # Adding an entry field textbox
        search_entry_textbox = ttk.Entry(self, textvariable=self.var_search, width=22, font=FONT3)
        search_entry_textbox.grid(row=6, column=1, columnspan=3, padx=150, pady=5, sticky=W)
        ...
        self.fetch_data()
        # UI Design for the search sstem completed
        # --------------------------------------------------------------------------- #
        ...
        capture_face_button.place(x=910, y=340, width=350, height=60)

        # Clear All Data button
        clear_all_button = ttk.Button(self, text="Clear All Fields", style="big.TButton", command=self.clear_all_button)
        clear_all_button.place(x=910, y=420, width=350, height=60)
...
# ========================================================================================================================================== #
# ========================================================================================================================================== #
class Add_New_Student_Page(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)

        # Adding the add new student Label
        Add_Student_Lbl = tk.Label(self, text="Add New Student", font=FONT1)
        Add_Student_Lbl.place(x=205, y=5, width=870, height=75)
        Add_Student_Lbl.config(bg="Black", fg="White")
        
        # Initialising the style to be used for the buttons
        style = ttk.Style()
        style.configure("big.TButton", font=('Calibri', 12), bg="White", fg="Black")
        ...
        # Getting the student ID from the database
        conn = mysql.connector.connect(host="localhost", username="root", password="utkarshjain120", database="ireg")
        my_cursor = conn.cursor()
        my_cursor.execute("SELECT * FROM tbl_student")
        student_IDs = my_cursor.fetchall()
    ...
    # Adding in the student related text boxes and labels
        ...
        studentID_lbl = Label(self, text = "Student ID: ", font=FONT3)
        studentID_lbl.config(bg="Black", fg="White")
        studentID_lbl.grid(row=0, column=0, padx=(250,15), pady=(250,15), sticky=E)

        self.new_studentID_lbl = Label(self, text = self.var_student_ID, font=FONT3)
        self.new_studentID_lbl.config(bg="Black", fg="White")
        self.new_studentID_lbl.grid(row=0, column=1, padx=15, pady=(250,15), sticky=W)


        # Adding a Student Email label and textbox
        student_email_lbl = Label(self, text = "Student Email: ", font=FONT3)
        student_email_lbl.config(bg="Black", fg="White")
        student_email_lbl.grid(row=0, column=2, padx=(20,15), pady=(250,15), sticky=E)

        student_email_textbox = ttk.Entry(self, width=25, textvariable=self.var_student_email, font=FONT3)
        student_email_textbox.grid(row=0, column=3, padx=15, pady=(250,15), sticky=W)
        ...
        first_name_textbox = ttk.Entry(self, width=25, textvariable=self.var_first_name, font=FONT3)
        first_name_textbox.grid(row=2, column=1, padx=15, pady=15, sticky=W)

        # Adding a last label and textbox
        last_name_lbl = Label(self, text = "Last Name: ", font=FONT3)
        last_name_lbl.config(bg="Black", fg="White")
        last_name_lbl.grid(row=2, column=2, padx=(20,15), pady=15, sticky=E)

        last_name_textbox = ttk.Entry(self, width=25, textvariable=self.var_last_name, font=FONT3)
        last_name_textbox.grid(row=2, column=3, padx=15, pady=15, sticky=W)

        # Adding a Student Date Of Admission label and textbox
        date_of_admission_lbl = Label(self, text = "Date Of Admission: ", font=FONT3)
        date_of_admission_lbl.config(bg="Black", fg="White")
        date_of_admission_lbl.grid(row=3, column=0, padx=15, pady=15, sticky=E)

        date_of_admission_textbox = ttk.Entry(self,width=25, textvariable=self.var_date_of_admission, font=FONT3)
        date_of_admission_textbox.grid(row=3, column=1, padx=15, pady=15, sticky=W)

        # Adding a date of birth label and textbox
        date_of_birth_lbl = Label(self, text = "Date of Birth: ", font=FONT3)
        date_of_birth_lbl.config(bg="Black", fg="White")
        date_of_birth_lbl.grid(row=3, column=2, padx=(20,15), pady=15, sticky=E)

        date_of_birth_textbox = ttk.Entry(self,width=25, textvariable=self.var_date_of_birth, font=FONT3)
        date_of_birth_textbox.grid(row=3, column=3, padx=15, pady=15, sticky=W)

        # Father's Information
        # Adding a father first name label and textbox
        father_name_lbl = Label(self, text = "Father's Name: ", font=FONT3)
        father_name_lbl.config(bg="Black", fg="White")
        father_name_lbl.grid(row=4, column=0, padx=15, pady=15, sticky=E)

        father_name_textbox = ttk.Entry(self, width=25, textvariable=self.var_father_name, font=FONT3)
        father_name_textbox.grid(row=4, column=1, padx=15, pady=15, sticky=W)

        # Adding father's email label and text box
        father_email_lbl = Label(self, text = "Father's Email: ", font=FONT3)
        father_email_lbl.config(bg="Black", fg="White")
        father_email_lbl.grid(row=4, column=2, padx=(20,15), pady=15, sticky=E)

        father_email_textbox = ttk.Entry(self, width=25, textvariable=self.var_father_email, font=FONT3)
        father_email_textbox.grid(row=4, column=3, padx=15, pady=15, sticky=W)

        # Mother's Information
        # Adding a father first name label and textbox
        mother_name_lbl = Label(self, text = "Mother's Name: ", font=FONT3)
        mother_name_lbl.config(bg="Black", fg="White")
        mother_name_lbl.grid(row=5, column=0, padx=15, pady=15, sticky=E)

        mother_name_textbox = ttk.Entry(self, width=25, textvariable=self.var_mother_name, font=FONT3)
        mother_name_textbox.grid(row=5, column=1, padx=15, pady=15, sticky=W)

        # Adding father's email label and text box
        mother_email_lbl = Label(self, text = "Mother's Email: ", font=FONT3)
        mother_email_lbl.config(bg="Black", fg="White")
        mother_email_lbl.grid(row=5, column=2, padx=(20,15), pady=15, sticky=E)

        mother_email_textbox = ttk.Entry(self, width=25, textvariable=self.var_mother_email, font=FONT3)
        mother_email_textbox.grid(row=5, column=3, padx=15, pady=15, sticky=W)

        # Adding a Save Student Profile button
        save_student_profile_button = ttk.Button(self, text="Save Student Profile", command=self.add_student_button)
        save_student_profile_button.place(x=5, y=720, width=420, height=50)
        
        # Adding a Clear All Fields button
        clear_all_fields_button = ttk.Button(self, text="Clear All Fields", command=self.clear_all_fields_button)
        clear_all_fields_button.place(x=430, y=720, width=420, height=50)

        # Adding a Capture Student Face button
        capture_student_face_button = ttk.Button(self, text="Capture Student Face", command=self.capture_face_button)
        capture_student_face_button.place(x=855, y=720, width=420, height=50)

        # Adding the back button
        back_button = ttk.Button(self, text="Back", command=lambda: controller.show_frame(Student_Account_Management_1_Page))
        back_button.place(x=5,y=5)
        # UI Design for getting the student's and their parents information completed
        # --------------------------------------------------------------------------- #
    #                                                            END OF UI DESIGN
    ...
    def add_student_button(self):
        if self.var_student_ID=="" or self.var_student_email.get()=="" or self.var_first_name.get()=="" or self.var_last_name.get()=="" or self.var_date_of_admission.get()=="" or self.var_date_of_birth.get()=="" or self.var_father_name.get()=="" or self.var_father_email.get()=="" or self.var_mother_name.get()=="" or self.var_mother_email.get()=="":
            ...
            try:
                ...
                conn.commit()
                conn.close()
                self.clear_all_fields_button()
                messagebox.showinfo("Success", "Student details have been added succesfully", parent=self)
                self.new_studentID_lbl.config(text=f"{int(self.var_student_ID)+1}")
            except Exception as es:
                messagebox.showerror("Error", f"Due To : {str(es)}", parent=self)
    # ------------------------------------------------------------------------------------------------------------------------------------------#
    # Clear All Fields button Implementation
    def clear_all_fields_button(self):
        self.var_student_email.set(""),
        self.var_first_name.set(""),
        self.var_last_name.set(""),
        self.var_date_of_admission.set(""),
        ...
        self.var_mother_email.set("")
    # -------------------------------------------------------------------------------------------------------------------------------------------#
    # Capture Student Face Implementation
    def capture_face_button(self):
        # Validation that all fields are filled up
        if self.var_student_ID=="" or self.var_student_email.get()=="" or self.var_first_name.get()=="" or self.var_last_name.get()=="" or self.var_date_of_admission.get()=="" or self.var_date_of_birth.get()=="" or self.var_father_name.get()=="" or self.var_father_email.get()=="" or self.var_mother_name.get()=="" or self.var_mother_email.get()=="":
            messagebox.showerror("Error", "All fields are required", parent=self)
...
class Settings_Page(tk.Frame):
    def __init__(self, parent, controller):
        ...
        # Adding the View Attendance
        train_data_Button =  ttk.Button(self, text="Train Data", command= lambda: Student_Account_Management_Page.train_data_button(self), style="big.TButton")
