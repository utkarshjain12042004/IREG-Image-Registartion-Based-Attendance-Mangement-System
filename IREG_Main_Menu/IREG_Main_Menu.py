...
class Face_Recognition_System:
    ...
    def __init__(self, root):
        ...
        # Label Frame
        Image_Registration_lbl = Label(mainFrame, text="IREG", font=("Helvetica", 25, "bold"), bg="White", fg="Red")
        Image_Registration_lbl.place(x=122, y=0, width=150, height=55)

        # Label Frame 2
        title_lbl = Label(mainFrame, text="Image Registration", font=("Helvetica", 25, "bold"), bg="White", fg="Red")
        ...
        # View Attendance
        view_Attendance_Button =  Button(Button_Frame, text="View Attendance", cursor="hand2", font=("Sans-Serif", 15, "bold"), bg="Dark Blue", fg="White")
        ...
        # Exit Button
        exit_Button = Button(Button_Frame, text="Exit", cursor="hand2", font=("Sans-Serif", 15, "bold"), bg="Dark Blue", fg="White")
        exit_Button.place(x=5,y=170, width=287, height=50)   
        
        # Settings Button
        settings_Button = Button(mainFrame, text="Settings", cursor="hand2", font=("Sans-Serif", 15, "bold"), bg="Dark Blue", fg="White")
