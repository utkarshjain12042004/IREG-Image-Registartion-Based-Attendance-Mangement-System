...
class Show_Attendance:
    ...
    def __init__(self, root):
        ...
        start_capture_Button = Button(Button_Frame, text="Start Capture", cursor="hand2", font=("Segoe UI Variable", 15, "bold"), bg="Black", fg="White")
        ...
        stop_capture_Button = Button(Button_Frame, text="Stop Capture", cursor="hand2", font=("Segoe UI Variable", 15, "bold"), bg="Black", fg="White")
        stop_capture_Button.place(x=5, y=60, height=50, width=365) # Specifying the coordinates along with the dimensions of the button
       
        # Back to student Account Management Button
        save_attendance_Button = Button(Button_Frame, text="Save Attendance", cursor="hand2", font=("Segoe UI Variable", 15, "bold"), bg="Black", fg="White")
        save_attendance_Button.place(x=5, y=115, height=50, width=365) # Specifying the coordinates along with the dimensions of the button
