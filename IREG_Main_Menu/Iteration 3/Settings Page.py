...
class Settings:
    ...
    def __init__(self, root):
        ...
        # Train Data Button
        train_data_button = Button(Button_Frame, text="Train Data", cursor="hand2", font=("Segoe UI Variable", 15, "bold"), bg="Black", fg="White")
        train_data_button.place(x=5,y=5, width=387, height=90)

        # Student Faces
        student_faces_Button =  Button(Button_Frame, text="Student Faces", cursor="hand2", font=("Segoe UI Variable", 15, "bold"), bg="Black", fg="White")
