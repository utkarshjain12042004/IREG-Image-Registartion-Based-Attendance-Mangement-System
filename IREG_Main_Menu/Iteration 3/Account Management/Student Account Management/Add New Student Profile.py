...
class Add_New_Student_Profile:
            ...
            # ---------------------------------------------------------------------------------------------------------------------------- #
                ...
                while True:
                    ...
                    if face_cropped(face_Frame) is not None:
                        ...
                        file_name_path = "C:/Users/utkarshjain120/Desktop/IREG-Image-Registartion-Based-Attendance-Mangement-System/Student_Faces/user." + str(id) + "." + str(img_id) + ".jpg"
    ...
    def train_data_button(self):
        data_dir = ("C:/Users/utkarshjain120/Desktop/IREG-Image-Registartion-Based-Attendance-Mangement-System/Student_Faces")
