...
class Add_New_Student_Profile:
    ...
    def __init__(self, root):
        ...
        # Label Frame
        Ass_New_Student_Profile_lbl= Label(mainFrame, text="Add New Student Profile", font=("Segoe UI Variable", 45, "bold"), bg="White", fg="Black")
        Ass_New_Student_Profile_lbl.place(x=1, y=5, width=1270, height=75) # Specifying the coordinates along with the dimensions of the frame
